...
# GET /email_messages/new — compose from intent. The Desk infers
# To/Subject from ?intent= / ?to= and renders them as inferred chips.
RSpec.describe "Compose from intent (Desk)", type: :request do
  ...
  it "does not prefill when intent and to are both blank" do
    get new_email_message_path
