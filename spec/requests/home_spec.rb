...
RSpec.describe "Home feed", type: :request do
  # Home is served to the native app shell only — web users are redirected to /now.
  # Every test that hits root_path or home_path must send the native UA.
  ...
  context "when signed in" do
    ...
    it "falls back to the first page for a direct overflowing page visit" do
      get home_path(page: 2), headers: { "HTTP_USER_AGENT" => native_ua }
