...
class ScheduledEmail < ApplicationRecord
  ...
  # Set when the scheduled email was built from a reusable EmailTemplate; lets the
  # send job re-render subject/body and regenerate attachments per occurrence.
