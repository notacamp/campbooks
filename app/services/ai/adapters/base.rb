module Ai
  module Adapters
    class Base
      ...
      # Provider name used as the circuit-breaker key. Matches the class name
      # (e.g. "anthropic", "openai", "mistral"). Openai overrides this when
      # pointing at the DeepSeek endpoint.
      def provider_name
