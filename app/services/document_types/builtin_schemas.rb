  ...
  module BuiltinSchemas
    ...
    ALL = {
      "expense_invoice" => {
        ...
        "amount_cents"    => { "type" => "money",  "position" => 2,
        ...
        "expense_category" => { "type" => "enum",  "position" => 6,
      ...
      "revenue_invoice" => {
        ...
        "client_nif"      => { "type" => "string", "position" => 9,
      ...
      "receipt" => {
        "vendor_name"   => { "type" => "string", "position" => 1,
                             ...
                             "description" => "Vendor Name" },
        "vendor_nif"    => { "type" => "string", "position" => 6,
        ...
        "amount_cents"  => { "type" => "money",  "position" => 2,
                             ...
                             "description" => "Amount (cents)" },
        "payment_method" => { "type" => "enum",  "position" => 5,
      ...
      "bank_statement" => {
        ...
        "closing_balance_cents" => { "type" => "money", "position" => 4,
